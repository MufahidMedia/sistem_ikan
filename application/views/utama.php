		...
		<div class="col-md-8">
			<div class="navbar-header">
					...
					if($role == 'Administrator') 
						...
						<img src="<?php echo base_url(); ?>assetku/img/logo_desa_pab.png" style="float:left; height: 70px; width: 70px; margin-top:2px; margin-bottom:2px; margin-right: 10px;"> 
						<span><h4><b>Sistem Manajemen Informasi</b> <br>Desa Paberasan</h4></span>
					</a>
			</div>				
		</div>
