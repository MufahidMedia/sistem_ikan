...
<img id="displayPhoto" src='<?php echo site_url($logo_desa);?>' style="float:left; height:50px; width:fixed; margin-top:-10px; margin-bottom:5px;"> 
<!--
...
-->		
<h3>Selamat Datang di Desa Paberasan</h3>
<script>
