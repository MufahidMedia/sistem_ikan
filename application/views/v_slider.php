...
{	
	...
	$logo = $sb->konten_logo;	
		...
		echo'
			...
			<div id="aaaa'.$count.'" class="item" style="background-image:url('.base_url().''.$background.'); style="width:100%; background-position: bottom center;" >
			  <div class="container" style="width:1500px;">
				<div class="row">
				 ...
				 <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
					...
					<img src="'.base_url().''.$logo.'" alt="..." style="float:center; height:100px; width:fixed; margin-top:;">
					</div>	
					</div>	
