...
<head>
	...
	<link rel="shortcut icon" href="<?php echo base_url();?>images/paberasan.ico" type="image/x-icon" />
	<title>Login Sistem Informasi Desa Paberasan</title>
...
<body style="background-image:url(<?php echo base_url(); ?>images/logo_desa.jpg);background-size:cover;">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel ">
                    ...
                    <div class="panel-heading" style="display: flex; justify-content: center; align-items: center; height: 225px;">
							<a href=" <?php 
							if($role == 'Login Sistem Informasi Desa Paberasan') 
								{
									echo site_url('/');
								}
							else{
								...
								<img src="<?php echo base_url(); ?>assetku/img/logoo desapab.jpeg" class="img-responsive" style="max-width: 200px; height: auto;"> 
							</a>						
                    </div>
					
                    <div class="panel-body">
						<h5 class="text-center"><i>Halaman Login Admin & Pengelola</i></h5>
