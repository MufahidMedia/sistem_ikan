...
class C_pindah_keluar extends CI_Controller {
	...
	function lists() {
        // $colModel['id_pindah_keluar'] = array('NO',30,TRUE,'left',0);
		$colModel['No'] = array('NO',30,TRUE,'center',0);	
		$colModel['aksi'] = array('Aksi',40,FALSE,'center',0);
        $colModel['tgl_pindah_keluar'] = array('Tanggal Pindah',100,TRUE,'center',2);
        $colModel['no_kk'] = array('No KK',120,TRUE,'center',2);
        $colModel['nama'] = array('Nama Kepala Keluarga',150,TRUE,'left',2);
        $colModel['alamat_jalan'] = array('Alamat',110,TRUE,'left',2);
        $colModel['nama_provinsi'] = array('Provinsi',150,TRUE,'center',2);
        $colModel['nama_kabkota'] = array('KabKota',100,TRUE,'center',2);
        $colModel['nama_kecamatan'] = array('Kecamatan',100,TRUE,'center',2);
        $colModel['nama_desa'] = array('Desa',100,TRUE,'center',2);
		$colModel['nama_dusun'] = array('Dusun',100,TRUE,'center',2);
		$colModel['nomor_rw'] = array('RW',30,TRUE,'center',2);
		$colModel['nomor_rt'] = array('RT',30,TRUE,'center',2);
