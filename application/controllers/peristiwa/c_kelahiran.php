...
class C_kelahiran extends CI_Controller {
    ...
    function lists() {
        // $colModel['id_kelahiran'] = array('NO',30,TRUE,'center',0);
		$colModel['No'] = array('NO',30,TRUE,'center',0);	
        $colModel['tgl_kelahiran'] = array('Tanggal Lahir',80,TRUE,'center',2);
        ...
        $colModel['tempat_lahir'] = array('Tempat Lahir',100,TRUE,'center',2);
        $colModel['penolong'] = array('Penolong',150,TRUE,'left',2);
