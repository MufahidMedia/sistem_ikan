...
class C_pindah_masuk extends CI_Controller {
	...
	function lists() {
        // $colModel['id_pindah_masuk'] = array('NO',30,TRUE,'left',0);
		$colModel['No'] = array('NO',30,TRUE,'center',0);	
        $colModel['tgl_pindah_masuk'] = array('Tanggal Pindah Masuk',120,TRUE,'center',2);
        $colModel['no_kk'] = array('No Kepala Keluarga',100,TRUE,'center',2);
        $colModel['alamat_jalan'] = array('Alamat',100,TRUE,'left',2);
        $colModel['ref_desa.nama_desa'] = array('Desa Tujuan',80,TRUE,'center',2);
		$colModel['ref_dusun.nama_dusun'] = array('Dusun Tujuan',80,TRUE,'center',2);
		$colModel['ref_rw.nomor_rw'] = array('RW Tujuan',70,TRUE,'center',2);
		$colModel['ref_rt.nomor_rt'] = array('RT Tujuan',70,TRUE,'center',2);
        $colModel['ref_jenis_pindah.deskripsi'] = array('Jenis Pindah',100,TRUE,'center',2);
        $colModel['ref_klasifikasi_pindah.deskripsi'] = array('Klasifikasi Pindah',120,TRUE,'center',2);
		$colModel['ref_alasan_pindah.deskripsi'] = array('Alasan Pindah',100,TRUE,'center',2);
