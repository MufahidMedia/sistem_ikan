...
class C_meninggal extends CI_Controller {
	...
	function lists() 
	{
        // $colModel['id_meninggal'] = array('NO',30,TRUE,'left',0);
		$colModel['No'] = array('NO',30,TRUE,'center',0);	
        $colModel['nama'] = array('Nama',100,TRUE,'left',2);
        $colModel['tgl_meninggal'] = array('Tanggal Meninggal',100,TRUE,'center',2);
        $colModel['sebab'] = array('Sebab',200,TRUE,'left',2);
	//	$colModel['id_penduduk'] = array('ID Penduduk',100,TRUE,'left',2);
        $colModel['penentu_kematian'] = array('Penentu Kematian',150,TRUE,'left',2);
