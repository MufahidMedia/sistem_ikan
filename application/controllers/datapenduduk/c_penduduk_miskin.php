...
class C_penduduk_miskin extends CI_Controller {
    ...
    function lists() {
        // $colModel['id_keluarga'] = array('NO',30,TRUE,'left',0);	
		$colModel['No'] = array('No',30,TRUE,'center',0);		
		$colModel['no_kk'] = array('No KK',150,TRUE,'center',2);
		$colModel['tbl_penduduk.nik'] = array('NIK Kepala Keluarga',150,TRUE,'center',2);
       ...
       /*  $buttons[] = array('Select All','check','btn');
        ...
        $data['page_title'] = 'DATA PROGRAM PERLINDUNGAN SOSIAL';		
