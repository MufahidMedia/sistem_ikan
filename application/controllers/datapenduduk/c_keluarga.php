...
class C_keluarga extends CI_Controller {
    ...
    function lists() {
		// $colModel['tbl_keluarga.id_keluarga'] = array('NO',30,TRUE,'left',0);
		$colModel['No'] = array('NO',30,TRUE,'center',0);
        $colModel['no_kk'] = array('No KK',150,TRUE,'center',2);
		$colModel['tbl_penduduk.nama'] = array('Nama kepala keluarga',200,TRUE,'left',1);
		$colModel['alamat_jalan'] = array('Alamat',150,TRUE,'center',1);
        $colModel['ref_rt.nomor_rt'] = array('RT',30,TRUE,'center',1);	
		$colModel['ref_rw.nomor_rw'] = array('RW',30,TRUE,'center',1);
        $colModel['ref_dusun.nama_dusun'] = array('Dusun',100,TRUE,'center',1);		
