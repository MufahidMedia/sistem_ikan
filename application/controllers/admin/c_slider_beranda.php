...
class C_slider_beranda extends CI_Controller {
    ...
    function lists() 
	{
		// $colModel['id_slider_beranda'] = array('NO',30,TRUE,'center',2);
		$colModel['No'] = array('NO',30,TRUE,'center',0);	
        $colModel['konten_background'] = array('Konten Background',275,TRUE,'left',2);
        $colModel['konten_teks'] = array('Konten Teks',350,TRUE,'left',2);
